...
"""
FastAPI application for the Asc Agent Under Demand Uncertainity Rl Env Environment.

This module creates an HTTP server that exposes the AscAgentUnderDemandUncertainityRlEnvironment
...
def main(host: str = "0.0.0.0", port: int = 8000):
    ...
    This function enables running the server without Docker:
        ...
        python -m asc_agent_under_demand_uncertainity_rl_env.server.app
    ...
    multiple workers:
        uvicorn asc_agent_under_demand_uncertainity_rl_env.server.app:app --workers 4
    """
    import uvicorn
